...
#[derive(TS)]
#[rescript(export, export_to = "top_level_type_as/")]
pub struct Foo {
    x: i32,
}
...
#[derive(TS)]
#[rescript(export, export_to = "top_level_type_as/", as = "String")]
pub enum EnumAsString {
    A(Unsupported),
    B(Unsupported),
}
#[derive(TS)]
#[rescript(export, export_to = "top_level_type_as/", as = "NormalEnum")]
pub enum EnumAsEnum {
    A(Unsupported),
    B(Unsupported),
}
#[derive(TS)]
#[rescript(export, export_to = "top_level_type_as/", as = "NormalStruct")]
