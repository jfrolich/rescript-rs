...
#[derive(TS)]
#[rescript(export, export_to = "export_to/with_str_to_file.ts")]
struct WithStrToFile;

#[derive(TS)]
#[rescript(export, export_to = "export_to/")]
struct WithStrToDir;

// --

#[derive(TS)]
#[rescript(export, export_to = &"export_to/with_str_ref_to_file.ts")]
...
#[derive(TS)]
#[rescript(export, export_to = format!("export_to/with_string_to_file.ts"))]
struct WithStringToFile;

#[derive(TS)]
#[rescript(export, export_to = format!("export_to/"))]
struct WithStringToDir;

// --

#[derive(TS)]
#[rescript(export, export_to = &format!("export_to/with_string_ref_to_file.ts"))]
...
fn check_export_complete() {
    ...
    let files = [
        ...
        "WithStringRefToDir.res",
        "to_absolute_file_path.ts",
        "ToAbsoluteDirPath.res",
    ];
